    ...
    <div className="flex min-h-screen flex-col bg-brand-white">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-4 py-12">
        <div className="text-center">
          <h1 className="font-teko text-4xl font-bold text-gray-900">Wie können wir helfen?</h1>
        </div>

        <Card>
          <h2 className="mb-2 font-semibold text-gray-900">Häufige Fragen</h2>
          <div className="flex flex-col gap-4 text-sm text-gray-700">
            <div>
              <p className="font-medium text-gray-900">Ich habe mein Passwort vergessen.</p>
              <p>
            ...
            <div>
              <p className="font-medium text-gray-900">Ich habe eine Frage zu meinem Abo/zur Rechnung.</p>
              <p>
            ...
            <div>
              <p className="font-medium text-gray-900">Ich habe einen Fehler gefunden.</p>
              <p>
        ...
        <Card>
          <h2 className="mb-2 font-semibold text-gray-900">Kontakt</h2>
