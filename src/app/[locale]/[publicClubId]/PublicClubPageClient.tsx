      ...
      {game ? (
        <div className="flex flex-col items-center gap-3 rounded-xl border border-gray-200 bg-white dark:border-white/10 dark:bg-white/5 px-8 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="font-teko text-5xl font-bold tabular-nums text-brand-emerald">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">{t("noLiveGame")}</p>
      )}

      <p className="mt-8 text-xs text-gray-400 dark:text-gray-500">{t("bookmarkHint")}</p>
      <p className="text-xs text-gray-400 dark:text-gray-500">{t("appComingSoon")}</p>
      </main>
      <PublicFooter />
    </div>
  );
